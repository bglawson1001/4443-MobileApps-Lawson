...
After it is running, copy paste this into a browser: http://165.227.222.91:8083 
...
if __name__ == "__main__":
    uvicorn.run("api:app", host="165.227.222.91", port=8083, log_level="debug", reload=True)
